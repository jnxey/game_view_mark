<template>
  <div class="widgets-image-target" draggable="true" @dragstart="handlerStart">
    <svg class="icon" viewBox="0 0 1152 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="40" height="40">
      <path
...
<script>
export default { name: 'glc-widget-image-target' };
</script>
<script setup>
import { WIDGET_MAP } from '../_models/index.js';

const handlerStart = (e) => {
  e.dataTransfer.setData('text/plain', JSON.stringify({ mark: WIDGET_MAP.image.mark }));
};
</script>
<style scoped lang="scss">
.widgets-image-target {
  display: flex;
  align-items: center;
