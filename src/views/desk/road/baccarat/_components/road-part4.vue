<template>
  <template class="row-box" v-for="(t1, x) in part.cols" :key="x">
  ...
  <canvas id="part4-canvas" class="part-canvas" :width="part.width" :height="part.height" />
</template>
<script setup>
