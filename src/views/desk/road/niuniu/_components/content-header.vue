<template>
  <div class="content-header flex-row align-center">
    <!--  台号信息  -->
...
.content-header {
  ...
  .table-box {
    ...
    background-color: var(--desk-niuniu-table-info-bg-color);

    .table-info-color {
      color: var(--desk-niuniu-table-info-text-color);
    }
  }
  .limit-box {
    padding: 5px 15px;
    border-radius: var(--gv-border-radius-big);
    border: 4px solid var(--desk-niuniu-layout-border-color);
    color: var(--desk-niuniu-table-limit-text-color);
    background-image: var(--desk-niuniu-table-limit-bg-color);

    &.blue {
      background-image: var(--desk-niuniu-table-limit-min-bg-color);
    }

    .label {
      color: var(--desk-niuniu-bg-text-color);
    }
  }
